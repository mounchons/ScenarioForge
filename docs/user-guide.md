...
> อัปเดตล่าสุด: 2026-07-03 (scenario-discovery v0.2.0 — เพิ่ม Ideation Panel + external AI)
...
**เตรียมอะไรก่อน:** ต้องมี `scenarios.json` แล้ว (เริ่ม module ใหม่ = เรียก scenario-discovery ก่อนเสมอ)
